...
public class RequestPermissionUtils {
	...
	public void aleraPermission(final String permissiontype, final int requestcode) {
		if (ContextCompat.checkSelfPermission(mContext, permissiontype) == PackageManager.PERMISSION_DENIED) {
			...
			// }
			ActivityCompat.requestPermissions((Activity) mContext, new String[] { permissiontype }, requestcode);
		} else {
		}
	}
