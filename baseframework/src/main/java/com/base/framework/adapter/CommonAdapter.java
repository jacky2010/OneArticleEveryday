...
import com.base.framework.viewholder.ViewHolder;
 ...
 */
public abstract class CommonAdapter<T extends Comparable> extends BaseAdapter {
    private Context context;
    private List<T> data;
    private final  int itemLayoutId;

    public CommonAdapter(int itemLayoutId, List<T> data, Context context) {
