...
import com.base.framework.entity.SlamBallUserBean;
...
public class AppContacts {
    public static String USER_SERIALIZE_NAME = "slamballuser";
    //--------------------------------------自定义的action
    private static final String BASE_ACTION = "com.nuodao.slamball.action.";
    //加载失败
    public static final String ACTION_LOADERROR = BASE_ACTION + "loaderror";
    //----------------------------------------自定义flag
    //加载失败的信息
    public static final String LOAD_MSG = "loaderror_msg";
    //加载信息的类型
    public static final String LOAD_TYPE = "load_type";
    //加载成功
    public static final int LOAD_SUCCESS = 0x1;
    //加载失败
    public static final int LOAD_ERROR = 0x2;
    //网络未连接
    public static final int LOAD_ERROR_NET = 0x4;
    //服务器出错
    public static final int LOAD_ERROR_SERVICE = 0x5;
    //没有数据
    public static final int LOAD_ERROR_NODATA = 0x6;
    //验证失败
    public static final int LOAD_ERROR_CHECKFALSE = 0x7;

    //重新加载数据
    public static final int LOAD_REPLAY = 0x3;
    //-------------------------------------------全局数据
    public static String TOKEN;//令牌
    public static String ACCOUNTID;//用户id
    //-------------------------------------------全局key
    public static String KEY_HFIVE_VERSION = "h5Version";
    public static String KEY_HASUNZIP = "hasUnZip";
    public static String KEY_TOKEN = "token";
    public static String KEY_ACCOUNT = "accountId";
    public static String KEY_IS_LOGIN = "isLogin";
    public static String KEY_IS_FIRSTLOGIN = "isFirstLogin";
    public static String KEY_ACCOUNT_SLAM = "accountAuserAccounSlam";
    public static String KEY_FRIENDCONFIRM_TYPE = "friendConfirmType";
    public static String KEY_LANGUAGE_TYPE = "languageType";
    public static String KEY_LOCATION = "location";//最后一次登录位置
    public static SlamBallUserBean SLAMBALL_USER = SlamBallUserBean.getInstance();
    public static String KEY_PWD = "pwd";
    public static int TENCET_ACCOUNT_TYPE = 7058;
    public static int TENCET_APPSDKID = 1400013365;
    //----------------------------------------------直播
    ...
    public static final int SDK_APPID = TENCET_APPSDKID;

    public static final int ACCOUNT_TYPE = TENCET_ACCOUNT_TYPE;
    ...
    public static String ACTION_MEMBER_ENTER_ROOM = "com.nuoda.slb.hostenterroom";
    public static String ACTION_MEMBER_LEAVE_ROOM = "com.nuoda.slb.leaveroom";
    public static String ACTION_AGREE_INVITE = "com.nuoda.slb.agreeinvite";
    public static String ACTION_MSG_AGREE_INVITE = "com.nuoda.slb.msgagreeinvite";
    public static String ACTION_MSGREFUSE_INVITE = "com.nuoda.slb.msgrefuseinvite";
    public static String ACTION_REFUSE_INVITE = "com.nuoda.slb.refuseinvite";
    public static String ACTION_CANCLE_INVITE = "com.nuoda.slb.cancleinvite";
    public static String ACTION_MSGCANCLE_INVITE = "com.nuoda.slb.msgcancleinvite";

    public static final int RECORDER_VIDEO = 0xfbc;
    public static final int HFIVE_VERSION_CODE = 1;
    public static final String CURRENT_H5_VERSION = "currentVersion";

    public static final String TAG_NAME = "tagname";
    //直播关注状态
    public static String VIDEO_FORCUS = "forcus_state";
    //直播地址
    public static String LIVE_ADDRESS = "live_address";
    //map地址的影射缓存
    public static String PAGEMAP_SP="PageMapConfig";
}
